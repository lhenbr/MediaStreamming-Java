...
/**
 * É comum criarmos uma classe videolibrary.Util que contenha enumeradores, constantes e métodos de utilidade que possivelmente venham a ser usados
...
{
    /**
     * Nas classes videolibrary.Util é comum definirmos as constantes do projeto, para ficarem de fácil acesso a todas as classes
    ...
    /**
     * Como precisamos fazer uma hard copy de Array Lists para mais de uma classe (atores e gêneros) em videolibrary.Video, fiz um método genérico aqui na videolibrary.Util.
     ...
     * Outro ponto importante é que é um método static. Portanto, ele pode ser chamado sem instanciar um objeto videolibrary.Util, pois é um método da classe.
     * @param aList
     * @return aListCopy
     */
